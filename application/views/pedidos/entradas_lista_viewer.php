            ...
            <div class="col-md-12">
                ...
                <div class="block">
                    ...
                    <div class="content controls">   
                        <form id="makedinputs" action="<?php echo site_url('') ?>pedidos/buscar">

                            <div class="col-md-6">
                                <div class="form-row">
                                    <div class="col-md-3 tar">Usuario:</div>
                                    <div class="col-md-9">
                                    ...
                                    foreach ($tiketEntradas->result() as $rowx) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#modal_default_3" data-toggle="modal" class="optenerID" alt="<?php echo strtoupper($rowx->estado); ?>" title="<?php echo $rowx->idTiket; ?>" name="<?php echo str_pad($rowx->folio, 5, "0", STR_PAD_LEFT); ?>"><span class="icon-plus-sign"></span> Ver</a> 
                                            </td>
                                        </tr>
