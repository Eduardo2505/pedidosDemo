                ...
                <div class="col-md-12">
                    ...
                    <div class="block">
                        ...
                        <div class="content controls">   
                            <form id="makedinputs" action="<?php echo site_url('') ?>entradas/buscar">
                                        ...
                                        foreach ($tiketEntradas->result() as $rowx) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#modal_default_3" data-toggle="modal" class="optenerID" title="<?php echo $rowx->idTiket; ?>" name="<?php echo str_pad($rowx->folio, 5, "0", STR_PAD_LEFT); ?>"><span class="icon-eye-open"></span> Ver</a> 
                                                </td>
                                            </tr>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('.optenerID').click(function() {
                    ...
                    $('#foliox').html('Entrada con el FOLIO ' + folio);
                    $('#boton').html('<a  class="btn btn-warning btn-clean" href="<?php echo site_url('') ?>entradas/reimprimir?idTiket='+user+'">REIMPRIMIR</a>');
                    var dataString = 'idtiket=' + user;

                    $.ajax({
                        type: "GET",
                        url: "<?php echo site_url('') ?>entradas/verproductos",
                        data: dataString,
